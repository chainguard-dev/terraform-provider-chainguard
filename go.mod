...
require (
	...
	github.com/google/go-containerregistry v0.16.2-0.20230919002926-dbcd01c402b2 // indirect
	...
	github.com/sigstore/policy-controller v0.8.3 // indirect
